...
- The existing library and notes remain separate, compact panes (200 and 280 px on desktop). Hiding folders produces the study's 280 px sidebar composition. Distraction-free mode retains the same writing measure.
...
- `npm run check`: TypeScript, ESLint, 128 unit/SQL tests, production build.
